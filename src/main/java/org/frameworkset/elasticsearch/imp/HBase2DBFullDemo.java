 ...
 * <p>hbase shaded client的版本号与hbase的版本相关，请根据hbase的版本调整hbase shaded client的版本号
 * CREATE TABLE `hbase2db` (
 *   `id` bigint(20) NOT NULL AUTO_INCREMENT,
 *   `agentId` varchar(4000) DEFAULT NULL,
 ...
 *   PRIMARY KEY (`id`)
 * ) ENGINE=InnoDB AUTO_INCREMENT=96288 DEFAULT CHARSET=utf8;
 * </p>
 ...
 * @version 1.0
 */
public class HBase2DBFullDemo {
	public static void main(String[] args){
		HBase2DBFullDemo esDemo = new HBase2DBFullDemo();
...
//		importBuilder.addFieldValue("testObject",testObject);
		...
		importBuilder.addFieldValue("title","解放");
		importBuilder.addFieldValue("subtitle","小康");

		importBuilder.addFieldValue("name","jack");
		importBuilder.addFieldValue("author","duoduo");
		importBuilder.addFieldValue("content","新华社消息：三台政策放开了");
		importBuilder.addFieldValue("oper","许三多");
...
//				String data = context.getStringValue("Info:i");
				...
				context.addFieldValue("agentInfo", SimpleStringUtil.object2json(agentInfo));

				context.addFieldValue("ipinfo",agentInfo.getIp());
				context.addFieldValue("optime",new Date());
